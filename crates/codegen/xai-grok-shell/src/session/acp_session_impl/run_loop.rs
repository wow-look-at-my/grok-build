        ...
        tokio::select! {
                ...
                maybe_cmd = cmd_rx.recv() => {
                    ...
                    match cmd {
                        ...
                        SessionCommand::RebuildAgentForDefinition { definition, zero_turn, system_prompt_label, responds_to } => {
                            let outcome = session.handle_rebuild_agent_for_definition(definition, zero_turn, system_prompt_label).await;
