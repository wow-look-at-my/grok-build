...
use super::setters::{
    ...
    set_openai_compatible_api_backend_inner, set_openai_compatible_api_key_configured_inner,
    set_openai_compatible_base_url_inner, set_openai_compatible_context_window_inner,
