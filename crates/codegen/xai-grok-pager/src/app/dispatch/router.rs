...
use super::notes::{
    ...
    dispatch_send_recap, dispatch_send_remember_note, dispatch_send_todo,
};
...
use super::settings::setters::{
    ...
    set_harness_model, set_hunk_tracker_mode, set_invert_scroll, set_keep_text_selection,
    set_max_thoughts_width, set_min_output_tokens_per_sec, set_multiline_mode,
    set_output_rate_sustained_secs, set_page_flip_on_send, set_prompt_suggestions,
    ...
    set_simple_mode, set_stop_gate_ci_failing, set_stop_gate_unfinished_todos, set_theme,
...
pub(crate) fn dispatch(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::SetHarnessModel(slot, model) => set_harness_model(app, slot, model),
        Action::SetMaxThoughtsWidth(v) => set_max_thoughts_width(app, v),
        Action::SetMinOutputTokensPerSec(v) => set_min_output_tokens_per_sec(app, v),
