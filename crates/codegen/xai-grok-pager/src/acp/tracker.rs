...
impl AcpUpdateTracker {
    ...
    /// Remove the streaming preview of a call that never renders as its own row.
    fn drop_streaming_preview(&mut self, tc: &acp::ToolCall, scrollback: &mut ScrollbackState) {
